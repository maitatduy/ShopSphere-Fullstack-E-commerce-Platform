        ...
        <section data-homepage-animate className="relative overflow-hidden bg-[#fafafa]">
            ...
            <div className="relative mx-auto grid max-w-7xl gap-6 px-4 py-8 sm:px-6 lg:grid-cols-[1.08fr_0.92fr] lg:gap-10 lg:px-8 lg:py-20">
                <div className="flex flex-col justify-center">
                    ...
                    <h1 className="max-w-xl text-[2.2rem] font-semibold leading-[0.96] tracking-[-0.08em] text-[#171717] opacity-100 transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] sm:text-[3rem] lg:text-[5rem]">
                        {slide.title}
                    </h1>
                    <p className="mt-4 text-[1rem] font-medium text-[#171717] opacity-100 transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] sm:text-[1.2rem] lg:text-[1.3rem]">
                        {slide.subtitle}
                    </p>
                    <p className="mt-3 max-w-lg text-[0.96rem] leading-7 text-[#4d4d4d] opacity-100 transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] sm:text-[1rem]">
                        {slide.description}
                    </p>

                    <div className="mt-8 flex flex-wrap items-center gap-3 opacity-100 transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)]">
                    ...
                    <div className="mt-8 flex flex-wrap items-center gap-4 opacity-100 transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)]">
                        <button
                            type="button"
                            onClick={onPrev}
                ...
                <div className="hidden lg:relative lg:flex lg:items-center lg:justify-center">
                    ...
                    />
                    <div className="relative w-full overflow-hidden rounded-[1.8rem] border border-[#ebebeb] bg-white p-2 shadow-[0_12px_40px_rgba(23,23,23,0.08)] transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] sm:rounded-4xl sm:p-3">
                        <img
                            src={slide.image}
                            alt={slide.title}
                            loading="eager"
                            decoding="async"
                            className="h-72 w-full rounded-[1.3rem] object-cover transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] sm:h-96 lg:h-128 lg:rounded-3xl"
                        />
                    </div>
                </div>
            </div>
